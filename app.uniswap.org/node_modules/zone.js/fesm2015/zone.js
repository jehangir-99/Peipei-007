 ...
 * Use of this source code is governed by an MIT-style license that can be
 * found in the LICENSE file at https://angular.io/license
 */function patchCustomElements(_global,api){const{isBrowser:isBrowser,isMix:isMix}=api.getGlobalObjects();if(!isBrowser&&!isMix||!_global.customElements||!("customElements"in _global))return;api.patchCallbacks(api,_global.customElements,"customElements","define",["connectedCallback","disconnectedCallback","adoptedCallback","attributeChangedCallback"])}
/**
 * @license
 * Copyright Google LLC All Rights Reserved.
 *
